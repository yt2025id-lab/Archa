# ARCHA PITCH DECK
## Decentralized Arisan with AI Yield Optimizer
...
│ ├─ Merchant Moe: 12.5% APY (risky)      │
│ └─ Agni Finance: 6.8% APY               │
│                                         │
│ Auto-allocate to best risk/reward       │
│                                         │
│ Current Yield: +$42/month               │
│                                         │
└─────────────────────────────────────────┘
```
...
| Low Gas Fees | ✅ Mantle | N/A | ❌ Ethereum | ❌ Ethereum |
| Easy Onboarding | ✅ Yes | ✅ Yes | ❌ Complex | ❌ Complex |
...
║  2026: MASS ADOPTION                                          ║
║  ┌─────────────────────────────────────────────────────────┐  ║
║  │ ⬜ Partnership dengan komunitas arisan offline          │  ║
║  │ ⬜ Integration dengan e-wallet Indonesia                │  ║
║  │ ⬜ Ekspansi ke negara SEA lainnya                       │  ║
║  │ ⬜ Target: $10M+ TVL                                    │  ║
║  └─────────────────────────────────────────────────────────┘  ║
║                                                               ║
╚═══════════════════════════════════════════════════════════════╝
...
- **Primary:** #10B981 (Green - Prosperity)
...
### Visual Elements
- Indonesian batik patterns as subtle background
- Traditional arisan imagery (gathering, money collection)
- Modern tech elements (blockchain nodes, AI)
- Mantle Network branding

### Font Suggestions
- **Headlines:** Playfair Display (elegant, traditional feel)
