...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    "about.description": "<strong>Archa</strong> adalah protokol arisan terdesentralisasi yang dibangun di atas blockchain <strong>Base L2</strong>. Setiap peserta menyetorkan <strong>IDRX</strong> (stablecoin Rupiah) secara berkala, dan giliran penerima ditentukan secara adil melalui smart contract. Yang membuat Archa berbeda: selama periode arisan berlangsung, dana yang terkumpul tidak diam begitu saja. Dana tersebut diputar ke protokol <strong>Thetanuts Finance</strong> untuk menghasilkan yield. Di akhir arisan, <strong>seluruh keuntungan yield dibagikan rata kepada semua peserta</strong>, jadi bukan hanya dapat giliran, tapi juga dapat bonus!",
    ...
    "howItWorks.step2.desc": "Setor jaminan IDRX sebagai komitmen. Akan dikembalikan di akhir arisan",
    "howItWorks.step3.title": "Setoran Berkala",
    "howItWorks.step3.desc": "Setor IDRX setiap periode. Dana diputar ke Thetanuts untuk yield",
    ...
    "advantages.adv3.desc": "Dana diputar ke Thetanuts Finance untuk menghasilkan yield yang dibagikan rata.",
    ...
    "advantages.adv5.desc": "Dibangun di Base L2 dengan biaya transaksi yang sangat murah.",
  ...
  en: {
    ...
    "howItWorks.step2.desc": "Deposit IDRX collateral as commitment. Will be returned at the end of arisan",
    "howItWorks.step3.title": "Periodic Deposits",
    "howItWorks.step3.desc": "Deposit IDRX every period. Funds are invested in Thetanuts for yield",
    ...
    "advantages.adv3.desc": "Funds are invested in Thetanuts Finance to generate yield distributed equally.",
    ...
    "advantages.adv5.desc": "Built on Base L2 with very low transaction fees.",
