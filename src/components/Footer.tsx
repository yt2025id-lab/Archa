...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "Twitter",
      href: "https://twitter.com/archaonchain",
      icon: (
    ...
    {
      name: "GitHub",
      href: "https://github.com/yt2025id-lab/Archa",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} Archa. All rights reserved.
            </p>
            <div className="flex items-center gap-2">
              <span className="text-gray-500 text-sm">Built for</span>
              <a
                href="https://www.mantle.xyz/hackathon"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M25 35L50 20L75 35V65L50 80L25 65V35Z" fill="#65B3AE"/>
                </svg>
                <span className="text-sm font-medium text-white">Mantle Global Hackathon 2025</span>
              </a>
            </div>
          </div>
        </div>
